        ...
        <div className="flex flex-col gap-10">
          ...
          >
            ...
            <div className="flex flex-col gap-3">
              <DefinitionBlock term={t("rates.feesAndTaxes.term1")}>{" "}{t("rates.feesAndTaxes.prose.providerFeeTerm")}{" "}</DefinitionBlock>
          ...
          >
            <p className="text-(--color-text-muted)">{" "}{t("rates.feesAndTaxes.prose.noFeeTable")}{" "}</p>
          </Section>

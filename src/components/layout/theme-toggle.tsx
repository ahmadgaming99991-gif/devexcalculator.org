...
export function ThemeToggle() {
  ...
  return (
    <button
      type="button"
      onClick={() => apply(next)}
      className="inline-flex size-[44px] shrink-0 items-center justify-center rounded-(--radius-control) border border-(--color-border) text-(--color-text-muted) hover:text-(--color-text)"
      title={label}
    >
